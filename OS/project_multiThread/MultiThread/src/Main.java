...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < config.workers; i++) {
            Worker worker = new Worker("worker-" + (i + 1), readyQueue, resourceManager, statistics, logger, running);
        ...
        monitor.interrupt();    //monitor เป็น thread เดียวที่ไม่มีกลไกหยุดตัวเอง
