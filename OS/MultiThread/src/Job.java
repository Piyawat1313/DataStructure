...
public class Job {
    ...
    public volatile long actualArrivalTime; // เวลาที่เข้าคิวจริง ระบบเห็น
    public volatile long startTime; // เวลาที่ Worker เริ่มทำงานนี้
    public volatile long resourceWaitStartTime; // เวลาที่เริ่มขอ resource
    public volatile long resourceAcquiredTime; // เวลาที่ได้ resource มา
    public volatile long finishTime;  // เวลาที่งานเสร็จสมบูรณ์
    public static final Job POISON_PILL = new Job("POISON_PILL", -1, -1, -1, ResourceType.NONE, -1, -1); 
    ...
    public long turnaroundTime(){
        return  finishTime - actualArrivalTime;
    }
    ...
    public long resourceWaitTime(){
        ...
        // เวลาตั้งต้นเริ่มรอ Semaphore จน acquire สำเร็จ
        return  resourceAcquiredTime - resourceWaitStartTime;
    }
